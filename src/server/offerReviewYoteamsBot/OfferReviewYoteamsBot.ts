...
import OfferReviewYoteamsMessageExtension from "../offerReviewYoteamsMessageExtension/OfferReviewYoteamsMessageExtension";
import { DialogSet, DialogState } from "botbuilder-dialogs";
// Initialize debug logging module
const log = debug("msteams");

/**
 * Implementation for Offer Review (yoteams) Bot
 */
@BotDeclaration(
    "/api/messages",
    new MemoryStorage(),
...
export class OfferReviewYoteamsBot extends TeamsActivityHandler {
    ...
    public constructor(conversationState: ConversationState) {
        super();
        // Message extension OfferReviewYoteamsMessageExtension
        this._offerReviewYoteamsMessageExtension = new OfferReviewYoteamsMessageExtension();
